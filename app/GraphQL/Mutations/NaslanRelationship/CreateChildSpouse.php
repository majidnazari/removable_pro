...
final class CreateChildSpouse
{
    ...
    public function resolveCreateChildSpouse($rootValue, array $args, GraphQLContext $context = null, ResolveInfo $resolveInfo)
    {

        // if (($args['relationship_type'] === "Father") || ($args['relationship_type'] === "Daughter")) //it is spouse relation and should check first with second and also check inverse relation too 
        // {
            $NaslanRelationModel= [
                "creator_id" =>1,
